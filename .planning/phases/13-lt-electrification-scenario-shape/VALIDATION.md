...
$env:PYTHONPATH='.'; $env:PYTHONUTF8='1'; python scripts/export_local_test_ch_hourly_csv.py --valuation-date 2026-06-15 --local-start-date 2026-06-16 --local-end-date 2030-12-31 --output output/ch_hfc_hourly_20260616_20301231_v11_holiday_pressure.csv --report .planning/phases/13-lt-electrification-scenario-shape/CH-HFC-HOURLY-CSV-20260616-20301231-V11-HOLIDAY-PRESSURE.md --prefix local_test_ch_hfc_20260616_20301231_v11_holiday_pressure --skip-build --fan-chart-output output/local_test_ch_hfc_20260616_20301231_v6_annual_only_guard_structural_fan_chart.parquet --enable-structural-shape-upgrade --structural-shape-upgrade-intensity 1.0 --structural-scenario-spread-intensity 1.9 --enable-negative-price-capture --negative-price-capture-intensity 1.0 --negative-price-floor -30 --enable-post-calibration-negative-rebalancer --post-calibration-negative-rebalancer-intensity 0.65 --enable-post-calibration-peak-shape-rebalancer --post-calibration-peak-shape-intensity 1.0 --max-weighted-negative-hours 0 --disable-cascade-trend-for-annual-only
$env:PYTHONPATH='.'; $env:PYTHONUTF8='1'; python scripts/audit_ch_pfc_hourly_shape.py --csv output/ch_hfc_hourly_20260616_20301231_v11_holiday_pressure.csv --forwards data/eex_forwards_history.parquet --report .planning/phases/13-lt-electrification-scenario-shape/CH-HFC-HOURLY-SHAPE-AUDIT-20260616-20301231-V11-HOLIDAY-PRESSURE.md
$env:PYTHONPATH='.'; $env:PYTHONUTF8='1'; python scripts/audit_ch_hfc_seasonal_coherence.py --csv output/ch_hfc_hourly_20260616_20301231_v11_holiday_pressure.csv --forwards data/eex_forwards_history.parquet --report .planning/phases/13-lt-electrification-scenario-shape/CH-HFC-SEASONAL-COHERENCE-AUDIT-20260616-20301231-V11-HOLIDAY-PRESSURE.md
$env:PYTHONPATH='.'; $env:PYTHONUTF8='1'; python scripts/audit_ch_hfc_vs_spot_shape.py --csv output/ch_hfc_hourly_20260616_20301231_v11_holiday_pressure.csv --spot data/epex_hourly.parquet --report .planning/phases/13-lt-electrification-scenario-shape/CH-HFC-VS-SPOT-SHAPE-AUDIT-20260616-20301231-V11-HOLIDAY-PRESSURE.md
$env:PYTHONPATH='.'; $env:PYTHONUTF8='1'; python scripts/build_ch_hfc_validation_workbook.py --csv output/ch_hfc_hourly_20260616_20301231_v11_holiday_pressure.csv --forwards data/eex_forwards_history.parquet --output output/ch_hfc_hourly_20260616_20301231_validation_charts_v11_holiday_pressure.xlsx --report .planning/phases/13-lt-electrification-scenario-shape/CH-HFC-HOURLY-VALIDATION-WORKBOOK-20260616-20301231-V11-HOLIDAY-PRESSURE.md --no-tables
```
...
| hourly CH HFC V11 holiday-pressure shape | completed; 39,841 Europe/Zurich hourly rows from 2026-06-16 00:00 to 2030-12-31 23:00, continuous CH/cantonal/neighbour holiday pressure, 356 fast/P10 negative hours, 0 weighted-mean negative hours, min fast/P10 -9.405115 EUR/MWh, EEX residual 0.000000, shape score 9.00/10 |
| HFC V11 seasonal coherence audit | completed; critical 0, warning 0 |
| HFC V11 vs CH spot shape audit | completed; score 9.00/10, holiday pressure keeps strong 1 May / 1 August de-rating while preserving EEX means |
| HFC V11 validation workbook | completed; `output/ch_hfc_hourly_20260616_20301231_validation_charts_v11_holiday_pressure.xlsx`, 15 sheets, 4 charts, 0 Excel structured tables, hidden chart data sheet |
