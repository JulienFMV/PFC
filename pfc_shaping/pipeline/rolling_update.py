    ...
    try:
        with _run_lock("rolling_update"):
            ...
            confidence_thresholds = {
                "6m": float(params.get("confidence_6m", 1.0)),
                "12m": float(params.get("confidence_12m", 0.85)),
                "24m": float(params.get("confidence_24m", 0.65)),
                "36m": float(params.get("confidence_36m", 0.45)),
            }
